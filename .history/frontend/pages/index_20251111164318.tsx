        ...
        <div className="max-w-7xl mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center space-x-6">
              <button className="text-cyan-200/80 hover:text-cyan-100 transition-colors duration-200 text-sm font-medium">
                📊 Dashboard
              </button>
              <button className="text-cyan-200/80 hover:text-cyan-100 transition-colors duration-200 text-sm font-medium">
                📈 Analytics
      ...
      <div className="relative overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-6 py-16">
          ...
          <div className="bg-white/5 backdrop-blur-xl rounded-3xl border border-white/10 shadow-2xl overflow-hidden">
            <div className="p-1 bg-gradient-to-r from-purple-500/20 to-cyan-500/20">
          ...
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="text-center">
              <div className="bg-gradient-to-r from-purple-500/20 to-cyan-500/20 border border-white/10 rounded-2xl p-6">
                ...
                <button className="bg-gradient-to-r from-purple-500 to-cyan-500 text-white px-8 py-3 rounded-xl hover:from-purple-600 hover:to-cyan-600 transition-all duration-200 font-semibold shadow-lg hover:shadow-cyan-500/25">
                  Essai Gratuit
                </button>
              </div>
            </div>
