...
import { PredictionInput, PredictionResponse } from '..global/types/prediction';
  ...
  return (
    <div className="max-w-6xl mx-auto p-6">
      ...
      <div className={`mb-6 p-4 rounded border ${
        ...
        {apiStatus === 'error' && (
          <p className="text-sm mt-1">Assurez-vous que le backend est démarré sur http://localhost:8000</p>
        )}
      </div>
